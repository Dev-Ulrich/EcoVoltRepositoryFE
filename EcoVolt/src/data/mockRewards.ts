...
export const mockRewards: Reward[] = [
  { id: 'reward-1', title: 'Badge EcoStarter', description: 'Reconhecimento pela primeira ação aprovada.', status: 'available', pointsCost: 0, requirement: 'Concluir uma ação sustentável.', progress: { current: 1, target: 1 } },
