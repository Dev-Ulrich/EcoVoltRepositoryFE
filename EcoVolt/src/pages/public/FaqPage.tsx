...
const questions = [
  ...
  { id: 'login', category: 'Acesso', question: 'Já posso entrar na minha conta?', answer: 'Nesta versão, a tela de login ainda é demonstrativa e informa que o acesso não está disponível. A autenticação faz parte da evolução da plataforma. Enquanto isso, você pode conhecer o projeto pelas páginas públicas.' },
  { id: 'senha', category: 'Acesso', question: 'Como faço para recuperar minha senha?', answer: 'A orientação exibida em Esqueci minha senha é entrar em contato com um administrador para alterar a senha. Ainda não há recuperação automática por e-mail nesta versão.' },
