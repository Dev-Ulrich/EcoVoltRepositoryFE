...
const questions = [
  ...
  { id: 'acoes', category: 'Ações e evolução', question: 'O que é uma ação sustentável?', answer: 'É uma atitude como reciclar, economizar água ou usar transporte sustentável. Na tela Enviar ação você encontra as categorias, ODS e pontos demonstrativos.' },
  { id: 'envios', category: 'Ações e evolução', question: 'Como vou enviar e validar minhas ações?', answer: 'Use Enviar ação para selecionar um vídeo MP4, MOV ou AVI de até 100 MB e descrever a atividade. O arquivo não é enviado. Nos detalhes você pode simular aprovação, recusa e revisão; as alterações duram até recarregar ou sair.' },
  { id: 'pontos', category: 'Ações e evolução', question: 'Como funcionarão os pontos, o XP e as missões?', answer: 'Uma aprovação simulada concede os pontos da categoria e 40 XP. Ao atingir os objetivos de uma missão, seus bônus são somados uma única vez. O tier do participante é fixo nesta demonstração.' },
  { id: 'recompensas', category: 'Ações e evolução', question: 'Já existem ranking e recompensas disponíveis?', answer: 'Sim. O ranking mensal pode ser filtrado por tier e acompanha os pontos locais. O catálogo mostra conquistas disponíveis, em progresso e bloqueadas. Não há benefício financeiro ou resgate real.' },
]
